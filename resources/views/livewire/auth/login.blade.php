        ...
        <form wire:submit.prevent="login" class="space-y-6">
            ...
            <div x-show="wakingUp"
                ...
                <div x-data="{ seconds: @entangle('secondsRemaining') }"
                    ...
                    <!-- If there is active rate limit seconds, show live ticking timer -->
                    <span x-show="seconds > 0">Too many attempts. Please wait <span x-text="seconds"></span> seconds.</span>

                    <!-- If normal error (like wrong password), show normal message -->
